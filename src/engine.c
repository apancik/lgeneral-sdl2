...
====================================================================
*/
void engine_set_status( int newstat )
{
...
static void engine_draw_bkgnd()
{
    ...
    write_text( gui->font_std, sdl.screen, sdl.screen->w - gui_panel_w - 2, sdl.screen->h - 2, tr("(C) 2001-2021 Michael Speck"), 255 );
...
static void engine_handle_button( int id )
{
    ...
    switch ( id ) {
        ...
        case ID_SPLIT:
            ...
            x = gui->unit_buttons->frame->img->bkgnd->surf_rect.x + 30;
            y = gui->unit_buttons->frame->img->bkgnd->surf_rect.y +
        		    gui->unit_buttons->frame->img->bkgnd->surf_rect.h - 10;
            /* for static unit menu:
        ...
        case ID_STRAT_MAP:
            /* toggle minimap */
            gui->minimap->hidden = !gui->minimap->hidden;
     	    mmview_hide(gui->minimap, gui->minimap->hidden);
            /* old strat map stuff:
            engine_hide_game_menu();
            gui_panel_hide();
